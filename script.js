const stages = {
  ...
  deaeration: {
    kicker: "راهکار دی‌اریشن",
    title: "کنترل اکسیژن، حفظ کیفیت محصول",
    text: "دی‌اریتورهای آب سرد، شربت و آب گرم برای کاهش اکسیژن محلول و افزایش ثبات محصول نهایی.",
    image: "assets/candle-hero.jpg",
    meta: [
      ["مدل", "آب سرد / شربت"],
      ["متریال", "304L / 316L"],
      ["کنترل", "اتوماتیک"],
